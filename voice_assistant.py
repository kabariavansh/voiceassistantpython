...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak("I have been created by vansh kabaria.")
            ...
            speak("I am your virtual assistant created by vansh kabaria")

        elif 'reason for you' in query:
            speak("I was created as a Minor project by Mister vansh kabaria ")
